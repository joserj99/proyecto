...
public class Sensor implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Sensor.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Sensor and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another Sensor.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((Sensor)other).equalKeys(this);
    }
