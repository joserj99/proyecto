...
@Entity(name="sensor2")
public class Sensor2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Sensor2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Sensor2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof Sensor2)) {
            return false;
        }
        Sensor2 that = (Sensor2) other;
    ...
    /**
     * Compares this instance with another Sensor2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Sensor2)) return false;
        return this.equalKeys(other) && ((Sensor2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[Sensor2 |");
